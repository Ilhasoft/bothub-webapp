...
module.exports = {
  ...
  BOTHUB_WEBAPP_USE_HOTJAR: JSON.stringify(process.env.BOTHUB_WEBAPP_USE_HOTJAR || true),
  ...
  BOTHUB_WEBAPP_PAYMENT_ENABLED: JSON.stringify(process.env.BOTHUB_WEBAPP_PAYMENT_ENABLED),
  BOTHUB_WEBAPP_TUTORIAL_ENABLED: JSON.stringify(process.env.BOTHUB_WEBAPP_TUTORIAL_ENABLED || false)
}
