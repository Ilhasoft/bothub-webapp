...
ARG BOTHUB_WEBAPP_PAYMENT_ENABLED
ARG BOTHUB_WEBAPP_TUTORIAL_ENABLED
...
ENV BOTHUB_WEBAPP_USE_SENTRY "${BOTHUB_WEBAPP_USE_SENTRY}"
...
ENV BOTHUB_WEBAPP_PAYMENT_ENABLED "${BOTHUB_WEBAPP_PAYMENT_ENABLED}"
ENV BOTHUB_WEBAPP_TUTORIAL_ENABLED "${BOTHUB_WEBAPP_TUTORIAL_ENABLED}"
