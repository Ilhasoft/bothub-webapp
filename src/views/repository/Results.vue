    ...
    <div v-if="repository">
      <div v-if="authenticated">
        <div
          ...
          <filter-result-example @filterType="currentCrossValidation = $event"/>
          <div class="evaluate__content-wrapper">
            <base-evaluate-versions
              :repository="repository" :crossValidationType="currentCrossValidation"/>
          </div>
        </div>
