<template>
  <div class="drawer">
    <button
      slot="trigger"
      class="drawer-title"
      @click="openCollapse()">{{ this.$i18n.t('webapp.analyze_text.analyze_text') }}</button>
          ...
          <form
            ...
            <div class="field has-text-right">
              <bh-button
                :disabled="submitting"
                type="submit"
                primary>{{ this.$i18n.t('webapp.analyze_text.analyze') }}</bh-button>
            </div>
          </form>
        </div>
        <bh-tabs
          ...
          <bh-tab-item label="To Humans">
            <div class="item">
              ...
              <div v-else>{{ this.$i18n.t('webapp.analyze_text.no_detected') }}</div>
            </div>
            <div
