  ...
  <layout title="My Profile on bothub">
      ...
      <div class="bh-grid">
        <div class="bh-grid__item text-center">
          <bh-button
            ...
            <span>{{ this.$i18n.t('webapp.my_profile.edit_your_profile') }}</span>
          </bh-button>
          <bh-button
            primary
            inverted
            ...
            <span>{{ this.$i18n.t('webapp.my_profile.change_password') }}</span>
          </bh-button>
        </div>
      </div>
    </div>
    <div class="bh-grid bh-grid--column my-profile__repositories">
      <div class="bh-grid__item">
        <h1>{{ this.$i18n.t('webapp.my_profile.repositories') }}</h1>
      </div>
      <div class="bh-grid__item">
        <pagination
          v-if="repositoryList"
    ...
    <bh-modal :open.sync="editProfileModalOpen">
      <div
        ...
        class="bh-grid">
        <div class="bh-grid__item">
          <h1>{{ this.$i18n.t('webapp.my_profile.modal_edit_your_profile') }}</h1>
    ...
    <bh-modal :open.sync="changePasswordModalOpen">
      <div
        ...
        class="bh-grid">
        <div class="bh-grid__item">
          <h1>{{ this.$i18n.t('webapp.my_profile.modal_change_password') }}</h1>
