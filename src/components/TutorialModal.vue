  ...
  data() {
    return {
      ...
      list: [
        ...
        { label: 'quick_test', route: 'tutorial/quick-test' },
        { label: 'test', route: 'tutorial/evaluate' },
        { label: 'inbox', route: 'tutorial/inbox' },
        { label: 'translate', route: 'tutorial/translate' },
        { label: 'integrate', route: 'tutorial/integrate' },
      ],
    };
  },
  computed: {
