  ...
  <div class="update-item">
          ...
          <div class="level-left">
            <h4 class="title is-4">
              ...
              <div class="subtitle is-7">
                <div v-if="by">
                  <div v-if="trained_at">
                    {{ this.$i18n.t('webapp.my_profile.trained_at', {
                  ...
                  <div v-else>
                    {{ this.$i18n.t('webapp.my_profile.training') }}
                  </div>
                </div>
                <div v-else>
                  {{ this.$i18n.t('webapp.my_profile.not_trained') }}
                </div>
              </div>
            </h4>
          </div>
    ...
    <bh-modal :open.sync="logModalOpen">
      <div class="update-item__log">
        <h2 class="title is-2">{{ this.$i18n.t('webapp.my_profile.training_log') }}</h2>
