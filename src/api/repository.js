...
export default {
  ...
  analyze(repositoryUUID, repositoryVersion, language, text) {
    return request.$http.post(`/v2/repository/repository-details/${repositoryUUID}/analyze/`, {
      repository_version: repositoryVersion,
      language,
      text
    });
  ...
  getRepositoryInfo(repositoryUUID, version) {
    return request.$http.get(`/v2/repository/info/${repositoryUUID}/${version}`);
  },
  debugParse(repositoryUUID, repositoryVersion, language, text) {
    return request.$http.post(`/v2/repository/repository-details/${repositoryUUID}/debug_parse/`, {
      repository_version: repositoryVersion,
      language,
      text
    });
  ...
  edit(
    ...
    return request.$http.patch(`/v2/repository/repository-details/${repositoryUuid}/`, {
      name,
      slug: newSlug,
      language,
      categories,
  ...
  getLanguagesStatus(repositoryUUID, version) {
    return request.$http.get(`/v2/repository/info/${repositoryUUID}/${version}/languagesstatus/`);
  },
  ...
  updateAuthorizationRole(repositoryUuid, userNickname, role) {
    return request.$http.patch(`/v2/repository/authorizations/${repositoryUuid}/${userNickname}/`, {
      role
    });
  },
