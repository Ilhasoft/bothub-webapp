<template>
  <div class="dashboard-layout">
    ...
    <div
      :class="collapse ? 'dashboard-layout__main-panel' : 'dashboard-layout__main-panel--collapsed'"
    >
      <div class="dashboard-layout__main-panel__header">
        <div class="dashboard-layout__main-panel__container">
            ...
            >
              ...
              >
               ...
               dashboard-layout__main-panel__header__info__left__wrapper__title"
                ...
                <version-dropdown v-if="versionEnabled" />
              </div>
              <span
          ...
          <div class="dashboard-layout__main-panel__header__right">
            ...
            >
              <b-icon icon="alert" size="is-small" type="is-white" />
            ...
            <div class="dashboard-layout__main-panel__header__right__container">
              ...
              >
                ...
                />
                <b-dropdown-item v-if="!authenticated" aria-role="listitem" @click="signIn()">{{
                  $t("webapp.landing_page.signin")
                }}</b-dropdown-item>
                <b-dropdown-item v-if="!authenticated" aria-role="listitem" @click="signUp()">{{
                  $t("webapp.landing_page.signup")
                }}</b-dropdown-item>
                <b-dropdown-item
                  v-if="authenticated"
                  aria-role="listitem"
                  @click="routerHandle('profile')"
                  >{{ myProfile.name }}</b-dropdown-item
                >
                <b-dropdown-item
                  v-if="authenticated"
                  aria-role="listitem"
                  @click="routerHandle('orgs')"
                  >{{ $t("webapp.layout.orgs") }}</b-dropdown-item
                >
                <b-dropdown-item
                  v-if="authenticated"
                  aria-role="listitem"
                ...
                <b-dropdown-item aria-role="listitem" @click="routerHandle('home')">
